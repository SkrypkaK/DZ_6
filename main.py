...
#     pass
# def write_output_file(input_task2_input, output_file_name):
#     with open(input_task2_input, 'r') as input_file, open(output_file_name, 'w') as output_file:
...
#         except ValueError:
#             output_file.write("Error")  # Если el нет в списке, напишите "Error"
...
def test_not_busy_children():
    ...
    result_list = get_result_list("task4_output.csv")
